...
class LeavesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'leave_type_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'reason' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        'commutation' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        'status' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'is_approved_by_employee_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'end_date' => '2021-06-26',
                'commutation' => 'Lorem ipsum dolor sit amet',
                'status' => 1,
                'is_approved_by_employee_id' => 1,
                'created' => '2021-06-26 15:05:23',
                'modified' => '2021-06-26 15:05:23',
                'deleted' => 1,
                'deleted_date' => '2021-06-26 15:05:23',
            ],
        ];
        parent::init();
    }
