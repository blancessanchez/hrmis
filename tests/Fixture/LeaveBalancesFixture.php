...
class LeaveBalancesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'balance' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'term_id' => 1,
                'balance' => 1,
                'created' => '2021-06-26 15:05:17',
                'modified' => '2021-06-26 15:05:17',
                'deleted' => 1,
                'deleted_date' => '2021-06-26 15:05:17',
            ],
        ];
        parent::init();
    }
