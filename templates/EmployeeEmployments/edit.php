...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $employeeEmployment->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $employeeEmployment->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="employeeEmployments form content">
            ...
            <fieldset>
                <legend><?= __('Edit Employee Employment') ?></legend>
                <?php
